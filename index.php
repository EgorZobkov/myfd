...
// Перенаправление на страницу сообщений пользователя
if(Params::getParam('page') === 'user-messenger') {
  require 'oc-content/themes/eva/user-messenger.php';
  exit;
}

if(Params::getParam('page') === 'events') {
  require 'oc-content/themes/eva/events.php';
  exit;
}
