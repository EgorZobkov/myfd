...
function ur_button_add($user_id = NULL, $item_id = NULL) {
  ...
  $options = ur_options();
  return '<a href="' . $link . '" class="ur-new-rating ur-button-new btn-pink" data-options-count="' . count($options) . '" rel="nofollow noreferrer">' . __('Rate this user', 'user_rating') . '</a>';
}
...
function ur_button_show($user_id = NULL, $user_email = NULL, $item_id = NULL) {
  ...
  return '<a href="' . $link . '" class="ur-show-rating ur-button-new ur-button-counts" rel="nofollow noreferrer"><strong>' . number_format($global_rating, 1) . '</strong> <span>' . __('Average rating', 'user_rating') . '</span></a>';
}
...
function ur_button_stars($user_id = NULL, $user_email = NULL, $item_id = NULL) {
  ...
  return '<a href="' . $link . '" class="ur-show-stars ur-stars-smaller" rel="nofollow noreferrer">' . ur_get_stars($global_rating) . '<em>' . number_format($global_rating, 1) . '</em></a>';
}
...
function ur_add_rating_link($user_id = NULL, $item_id = NULL) {
  $link = ur_add_rating_link_raw($user_id, $item_id);
  return '<a href="' . $link . '" id="add-new-rating" class="add-new-rating ur-button" rel="nofollow noreferrer">' . __('Rate this user', 'user_rating') . '</a>';
}
...
function ur_show_rating_link($user_id = NULL, $item_id = NULL) {
  $link = ur_show_rating_link_raw($user_id, $item_id);
  return '<a href="' . $link . '" id="show-rating" class="show-rating ur-button" rel="nofollow noreferrer">' . __('Show rating', 'user_rating') . '</a>';
}
...
function ur_show_rating_stars($user_id = NULL, $user_email = NULL, $item_id = NULL) {
  ...
  $html = '<a href="' . $link . '" id="show-rating" class="show-rating show-stars" title="' . osc_esc_html(__('Click to show user reviews', 'user_rating')) . '" rel="nofollow noreferrer">';
