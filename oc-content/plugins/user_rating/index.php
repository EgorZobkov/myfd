...
osc_add_route('ur-ratings', 'user/rating', 'user/rating', osc_plugin_folder(__FILE__).'user/rating.php', true, 'custom', 'ur-myrating', __('Ratings', 'user_rating'));
...
function ur_menu($title = NULL) {
  ...
  $text .= '<li><a href="' . osc_admin_base_url(true) . '?page=plugins&action=renderplugin&file=user_rating/admin/configure.php"><i class="fa fa-wrench"></i><span>' . __('Configure', 'user_rating') . '</span></a></li>';
  $text .= '<li><a href="' . osc_admin_base_url(true) . '?page=plugins&action=renderplugin&file=user_rating/admin/rating.php"><i class="fa fa-comments"></i><span>' . __('Rating', 'user_rating') . '</span></a></li>';
  $text .= '</ul>';
  $text .= '</div>';
  $text .= '</div>';
