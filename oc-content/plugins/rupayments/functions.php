  ...
  //  function ppaypal_crypt ($string)
   ...
   // }
    ...
    function wallet_button ( $amount = '0.00', $description = '', $itemnumber = '101', $extra_array = '||' ) {
        ...
        print '<a class="wallet udisbutton" href="/index.php?page=custom&route=rupayments-wallet&a='.$amount.'&desc='.$description.'&extra='.$extra.'">';_e( "Pay with credit", "rupayments" );print '</a>';
