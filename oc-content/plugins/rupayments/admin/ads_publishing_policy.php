<?php defined('ABS_PATH') or die('Access denied');
    ...
    function categoriesList ( $categories, $depth = 0, $cat_policy, $group_id ) {
        
        foreach($categories as $c) { 
?>
            <tr <?php for($d=0; $d<$depth; $d++): ?>id="subcategories" class="hide" parent-id="<?php echo $c['fk_i_parent_id']; ?>" group-id="<?php echo $group_id; ?>"<?php endfor; ?>>
                <td>
                    ...
                    <?php if(!$depth) echo '<strong>' . $c['s_name'] . '</strong>'; else echo '<em>' . $c['s_name'] . '</em>'; ?>
                </td>
        ...
        <?php categoriesList($c['categories'], $depth+1, $cat_policy, $group_id);
        }
    };
?>
