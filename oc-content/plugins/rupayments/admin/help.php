...
<div class="rupayments-manage-wrapper">
    <div style="margin: 15px;">
        <div class="accordion">
            ...
            <section class="accordion_item">
                <h3 class="title_block"><?php _e('Yandex', 'rupayments'); ?></h3>
                
                <div class="info">
            <p class="info_item">
                <?php _e('Login or register in', 'rupayments'); ?> <a style="color:#2aa4db;" href="https://money.yandex.ru/" target="_blank">https://money.yandex.ru/</a>
            </p>
			<p class="info_item">
                <?php _e('Зайдите в Настройки - Всё остальное - Сбор Денег - Уведомления - Настроить .', 'rupayments'); ?>
            </p>
			<p class="info_item">
                <?php _e('HTTP-уведомления. Вставьте адрес:', 'rupayments'); ?><b style="color: #2aa4db;">http://<?php echo $_SERVER['SERVER_NAME'].'/index.php?page=custom&route=rupayments-payments-yandex-notification';?></b>
            </p>
			<p class="info_item">
                <?php _e('Поставьте галочку - Отправлять уведомления и сохраните настройки. Далее нажмите показать секрет. Вставьте данный набор символов в поле плагина Секретное слово Яндекс', 'rupayments'); ?>
            </p>
			<p class="info_item">
                <?php _e('Вставьте номер Вашего кошелька в поле плагина Номер вашего кошелька и сохраните.', 'rupayments'); ?>
            </p>
			<p class="info_item">
                <?php _e('Тестовой среды ЯндексДеньги не имеют. Поэтому для тестов можно только сделать реальные платежи.', 'rupayments'); ?>
            </p>
			<p class="info_item">
                <?php _e('Важно! При оплате с мобильных телефонов - Яндекс не присылает уведомлений на сайт. Поэтому если Вы включите эту опцию, обрабатывать платежи придётся вручную.', 'rupayments'); ?>
            </p>
                </div>
            </section>
       ...
       <p class="info_item">
		...
		<p class="info_item">Подтвержение платежа: Требуется</p>
		  <p class="info_item">
			...
			<p class="info_item">
            Result URL: <b style="color: #2aa4db;"><?php echo osc_base_url() .'oc-content/plugins/rupayments/payments/webmoney/status.php';?></b>
        </p>
       <p class="info_item">
