...
class AdminMenu {
 ...
 $this->add_menu(__('Мероприятия'), osc_admin_base_url(true) . '?page=events', 'events', 'administrator');
    $this->add_menu(__('Услуги'), osc_admin_base_url(true) . '?page=services', 'services', 'administrator');
