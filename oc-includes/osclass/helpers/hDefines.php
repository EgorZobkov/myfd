 ...
 * @return string
 */
function osc_user_edit_url() {
  if (osc_rewrite_enabled()) {
            return osc_base_url(true) . osc_get_preference('rewrite_user_edit', 'osclass');
        } else {
            return osc_base_url(true) . '?page=user&action=edit';
        }
  return $path;
}
...
//  */
// function osc_user_edit_url() {
// if (!function_exists('osc_user_edit_url')) {
//     function osc_user_edit_url() {
//         if (osc_rewrite_enabled()) {
//             return osc_base_url(true) . osc_get_preference('rewrite_user_edit', 'osclass');
//         } else {
...
function osc_user_profile() {
  $path = osc_base_url(true) . '?page=user&action=profile';
  return $path;
}
...
function osc_user_list_items_url($page = '', $typeItem = '') {
  if (osc_rewrite_enabled()) {
    ...
    if($page=='') {
      return osc_base_url(true) . '?page=user&action=profile' . $typeItem;
    } else {
